                ...
                <div class="col-lg-12">
                    <div class="nav-inner">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <a class="navbar-brand" href="<?php echo "https://corpindex.in/" ?>">
                ...
                <div class="col-lg-7 col-md-12 col-12">
                    ...
                    <div class="contact-item-wrapper">
                        <div class="row">
                            ...
                            <a href="https://corpindex.in/" style="text-decoration: none; color: inherit;">
                                <div class="col-12 col-md-6 col-xl-12">
                                    <div class="contact-item wow fadeInUp" data-wow-delay=".8s">
                                        ...
                                        <div class="contact-content">
                                            <h4><?php echo 'Back to Home' ;?></h4>
                                            <p><?php echo 'Go to CorpIndex' ;?></p>
                                        </div>
                                    </div>
                                </div>
                            </a>
...
<?php if (!is_loggedin()) { ?>
    <script>
        $(document).ready(function() {
            setTimeout(() => {
                $('.plans-purchase[data-id="1"]').trigger('click'); // provide the id of the package that is need to display when the page gets fully loaded...
            }, 1500);
        });
    </script>
<?php } ?>